-- Add referral_code and show_referral_code columns to opportunities table
ALTER TABLE public.opportunities 
ADD COLUMN IF NOT EXISTS referral_code TEXT,
ADD COLUMN IF NOT EXISTS show_referral_code BOOLEAN DEFAULT false;

-- Update the UPSERT RPC to handle referral_code
...
BEGIN
    ...
    INSERT INTO public.opportunities (
        ...
        referral_code, show_referral_code
    )
    SELECT
        ...
        r.referral_code,
        COALESCE(r.show_referral_code, false)
    ...
    ON CONFLICT (id) DO UPDATE SET
        ...
        referral_code = COALESCE(EXCLUDED.referral_code, public.opportunities.referral_code),
        show_referral_code = COALESCE(EXCLUDED.show_referral_code, public.opportunities.show_referral_code)
