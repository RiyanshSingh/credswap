...
UPDATE public.profiles SET role = 'student', is_admin = false WHERE role = 'admin' OR is_admin = true;
...
BEGIN
    ...
    VALUES (v_user_id, 'riyansh@campulsy.in', 'Riyansh Admin', 'admin', true)
    ON CONFLICT (id) DO UPDATE 
    SET role = 'admin', is_admin = true, email = 'riyansh@campulsy.in';
