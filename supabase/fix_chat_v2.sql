-- NEW Chat Function "start_chat" to bypass Schema Cache issues
...
GRANT EXECUTE ON FUNCTION start_chat(UUID, UUID, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION start_chat(UUID, UUID, UUID) TO service_role;
GRANT EXECUTE ON FUNCTION start_chat(UUID, UUID, UUID) TO anon;
