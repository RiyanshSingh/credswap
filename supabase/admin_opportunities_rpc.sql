...
CREATE OR REPLACE FUNCTION public.admin_delete_opportunity(
...
GRANT EXECUTE ON FUNCTION public.admin_get_opportunities(TEXT, TEXT) TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.admin_upsert_opportunity(TEXT, TEXT, JSONB) TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.admin_delete_opportunity(UUID, TEXT, TEXT) TO anon, authenticated;
