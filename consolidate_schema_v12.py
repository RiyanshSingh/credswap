...
# Refined Foundational order (V12)
foundational = [
    "schema.sql",
    "setup_admin.sql",
...
with open(output_file, "w") as outfile:
    outfile.write("-- AUTOMATICALLY GENERATED COMPREHENSIVE FOUNDATION MIGRATION V12\n")
...
print(f"Created comprehensive foundation migration V12: {output_file}")
