...
# I will find the 'return (' and the '<Dialog' and replace everything in between.

return_start_marker = 'return ('
dialog_start_marker = '<Dialog'

start_idx = full_content.find(return_start_marker)
end_idx = full_content.find(dialog_start_marker)
...
'''
    new_content = full_content[:start_idx] + "return (\n" + header_section + "\n" + full_content[end_idx:]
    with open(file_path, "w") as f:
        f.write(new_content)
    print("Success: Return block replaced.")
else:
