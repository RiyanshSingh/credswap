  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        soft: "0 2px 8px -2px hsla(230, 25%, 12%, 0.08)",
        medium: "0 8px 24px -8px hsla(230, 25%, 12%, 0.12)",
        large: "0 16px 48px -12px hsla(230, 25%, 12%, 0.16)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "marquee-scroll": {
          ...
          "40%, 60%": { transform: "translateX(calc(-100% + 130px))" },
      ...
      animation: {
        ...
        "marquee-scroll": "marquee-scroll 6s linear infinite",
      },
      backgroundImage: {
